try:
    ...
    print("❌ Библиотека googletrans не установлена!")
    print("Установите её командой: pip install googletrans==4.0.0-rc1")
    exit()
